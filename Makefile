...
BUILD_FILES=glauth.go bindata.go ldapbackend.go webapi.go configbackend.go commonsqlbackend.go sqlitebackend.go mysqlbackend.go postgresqlbackend.go localtoolbox.go
